...
A Codex skill for coordinating multi-module projects, automatically routing useful supporting skills, and keeping ordinary work out of unnecessary review loops.
...
The controller may handle a brief, isolated, reversible change directly when no executor owns the files. Substantial implementation, non-obvious debugging, long verification, and parallel modules normally go to Terra.
